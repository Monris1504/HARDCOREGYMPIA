    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Plan_1", x => x.IDPlan);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Producto_1", x => x.IDProducto);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Plan_Idplan",
                        column: x => x.Idplan,
                        principalTable: "Plan",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompraDetalle", x => new { x.IDCompra, x.IDProducto });
                    table.ForeignKey(
                        name: "FK_CompraDetalle_Compra",
                        column: x => x.IDCompra,
                        principalTable: "Compra",
                        principalColumn: "IDCompra");
                    table.ForeignKey(
                        name: "FK_CompraDetalle_Producto",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Carrito_1", x => new { x.IDUsuario, x.IDProducto });
                    table.ForeignKey(
